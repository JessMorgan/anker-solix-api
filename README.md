<div class="container">
  ...
  <img src="https://public-aiot-fra-prod.s3.dualstack.eu-central-1.amazonaws.com/anker-power/public/product/2025/05/07/iot-admin/a1Z9dqBT07gTGgyz/picl_A1763_US_normal.png" alt="Solix C1000 Gen2 Logo" title="Anker Solix C1000 Gen2"  align="right" height="80px"/> </div>
</div>
...
1. **[Api cache hierarchy generated by data poller methods](#api-cache-hierarchy-generated-by-data-poller-methods)**
1. **[Supported devices](#supported-devices)**
1. **[MQTT client](#mqtt-client)**
1. **[AnkerSolixApi Tools](#ankersolixapi-tools)**
   * [test_api.py](#test_apipy)
   * [export_system.py](#export_systempy)
   * [monitor.py](#monitorpy)
     - [Live Monitor key menu](#live-monitor-key-menu)
     - [File usage Monitor key menu](#file-usage-monitor-key-menu)
     - [Command line options for monitor tool](#command-line-options-for-monitor-tool)
   * [mqtt_monitor.py](#mqtt_monitorpy)
     - [MQTT Monitor key menu](#mqtt-monitor-key-menu)
...
> [!IMPORTANT]
> [Poetry 2.1.0](https://github.com/python-poetry/poetry/releases/tag/2.0.0) or later is required for full support of the pyproject.toml file, see issue [#208](https://github.com/thomluther/anker-solix-api/issues/208).
